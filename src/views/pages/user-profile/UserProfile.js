...
import Notification from 'src/views/pages/user-profile/notification'
import Connections from 'src/views/pages/user-profile/connections'
import Wallet from 'src/views/pages/user-profile/wallet'
import Security from 'src/views/pages/user-profile/security'
